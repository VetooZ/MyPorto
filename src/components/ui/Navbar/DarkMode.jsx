...
const DarkMode = () => {
    ...
    return (
        <div className="transition bg-white dark:bg-gray text-primary dark:text-white ease-out duration-1000 dark:ease-out dark:duration-700 flex items-center justify-center rounded-full button-spin">
