        ...
        <div className="fixed inset-0">
            ...
            <BackgroundBeamsWithCollision>
                <div className="flex flex-col">
                    <div className="flex flex-col mt-4 justify-center items-center text-white">
